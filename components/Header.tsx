...
const publicLinks = [
  { key: "home", href: "/dashboard/customer", icon: FiHome, label: "Home" },
  ...
  { key: "contact", href: "/dashboard/customer/contact", icon: FiMail, label: "Contact" }
];

const customerLinks = [
  { key: "customer", href: "/dashboard/customer", icon: FiHome, label: "Overview" },
  { key: "catalog", href: "/dashboard/customer/catalog", icon: FiGrid, label: "Catalog" },
  { key: "orders", href: "/dashboard/customer/profile/orders", icon: FiPackage, label: "Pesanan" },
  { key: "profile", href: "/dashboard/customer/profile/addresses", icon: FiMapPin, label: "Alamat" },
  ...
  return (
    <header className="site-header">
      ...
      <div className="header-main">
        <Link className="brand" href="/dashboard/customer">
