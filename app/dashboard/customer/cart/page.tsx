...
export default function CartPage() {
  ...
  const shipping = subtotal > 90000 ? 0 : 18000;
  ...
  async function createOrder() {
    ...
    try {
      const order = await createOrderFromCart(items, subtotal + shipping);
      await clearCart();
      setItems([]);
      ...
      <main className="dashboard-shell">
        ...
        <section className="checkout-grid">
          ...
          <aside className="summary-card">
            ...
            <p><span>Ongkir</span><strong>{shipping ? rupiah(shipping) : "Gratis"}</strong></p>
            <p><span>Voucher</span><strong>SNAPSHIP</strong></p>
            <hr />
            <p><span>Total bayar</span><strong>{rupiah(subtotal + shipping)}</strong></p>
