...
import {
  ...
  SnapFooter,
  SnapHeader
} from "@/components/snap/SnapCommon";
      ...
      <main>
        ...
        <section className="home-hero">
          <div>
            ...
            <h1>
              Fresh groceries from your nearest branch.
            </h1>

            <p>
              Belanja kebutuhan harian lebih cepat,
              praktis, dan segar langsung dari cabang
              terdekat Market Snap.
            </p>
            ...
            <div className="hero-buttons">
              ...
              <Link
                ...
                href="/dashboard/customer/profile/orders"
              >
                Pesanan saya
              </Link>
            </div>
            ...
            <div className="feature-row dashboard-features">
              <span>
                <FiTruck />
                Delivery 20-30 menit
              </span>

              <span>
                <FiMapPin />
                {state.store?.name ?? "Market Snap"}
              </span>
        ...
        <section className="snap-section">
          <div className="promo-banner">
            <div className="promo-copy">
              ...
              <h2>
                Gratis ongkir untuk pembelian
                di atas Rp 100.000
              </h2>

              <p>
                Nikmati pengiriman cepat dan
